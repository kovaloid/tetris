...
public class TetrisMenuBar extends JMenuBar {
  ...
  public TetrisMenuBar(Tetris tet) {
    ...
    returnToMenu.addActionListener(e -> t.menuOn());
    ...
    save.addActionListener(e -> {
      if (!t.isMenu()) {
        String name1 = JOptionPane.showInputDialog(null, "What name would you like to save this game under?\nNote: Your name can be no longer than 10 characters.",
    ...
    instructions.addActionListener(e -> JOptionPane.showMessageDialog(null, "Up        -Rotate\nLeft      -Move Left\nRight    -Move Right\nDown   -Drop\nSpace  -Hold" +
    ...
    about.addActionListener(arg0 -> JOptionPane.showMessageDialog(null, "Tetris by Artem Kovalev\nCopyright 2017",
